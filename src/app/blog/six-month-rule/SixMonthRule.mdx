...
Every 6 months you should be leaps and bounds ahead in your skill level. If you are the same knowledge level then you're doing something wrong. The tech field is changing rapidly, ***very rapidly***. Remember when GPT 3.5 was released? That was [November 2022](https://en.wikipedia.org/wiki/GPT-3#GPT-3.5) . Now this model is absolutely horrible compared to the latest generation of models.

I often go back and look at my own code and sit back and reflect "What could I have done better with that I know now?". If I can't think of a better way to implement the feature or project that I created then something is wrong (I have not ran into this yet).

The drive for continuous learning is what attracts me so much to this field. It's infectious. There are an insane number of different subsets of the software development field and an even more insane amount of resources for you to learn more. I never want to be the smartest person in the room. Knowledge is free on the internet and people love to share their knowledge. 
...
Focus on the results of your refactor and not the "looks and feels". Could you be doing something more efficiently and it's holding you back? Refactor it. Does this block of code just look ugly and you can clean it up? Leave it alone. You should've cleaned up that code in the first place. _Looks are not comparable to efficiency_.
