...
![microslop](/blog/microslop.png)

_aside: above rant is not including [PowerToys](https://github.com/microsoft/PowerToys). these guys are great._
...
- Hyprland? One of the first things I do with a new Windows installation is use [Fancy Zones](https://learn.microsoft.com/en-us/windows/powertoys/fancyzones) from Microsoft Powertoys (BTW, don't forget Powertoys is peak MSFT software). Oh, there's a Linux tiling manager that already does this? Without the fancy setup that I manually create?
