  ...
  return (
    <>
      ...
      <Link
        ...
        href="https://github.com/NickTheWilder"
      >
        GitHub
      </Link>
      <Link
        className={styles.link}
        href="https://open.spotify.com/user/12166567543?si=5bf12dc3c6394190"
      >
        <span className={styles.s}>S</span>p
        <span className={styles.otif}>otif</span>
